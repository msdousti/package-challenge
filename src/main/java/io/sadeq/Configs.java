...
public class Configs {
    ...
    /*
     * DynamicProgramming requires a table of order O(N*W),
     * where N is the number of items, and W is the possible
     * number of values for weight. The following constant
     * gives an upper bound for W.
     */
