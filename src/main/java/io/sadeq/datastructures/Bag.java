 ...
 * (@{code labels}). It creates a "bag" of the corresponding items, and
 * computes the total weight and price of items in the bag. It also computes
...
public final class Bag {
     ...
     */
    public Bag(final Map<Integer, Item> map,
